...
TASKS = {
 ...
 '10-zamow': ('g1', True, False, (
    ...
    'coloured dots each with a SHORT COLOUR NAME label like "Jasnoniebieski", "Granatowy", "Rozowy", '
    '"Pomaranczowy", "Czarny B" (ONLY these real SKU colour names: Fioletowy, Czarny, Czerwony, Jasnoniebieski, Granatowy, Rozowy, Pomaranczowy, Czarny B — NEVER invented colours like Bezowy/Bialy/Brazowy, NEVER hex codes), the purple one selected with a violet ring; a payment choice pill "Platnosc '
