...
hook + cta ZOSTAJA z v2. ASCII printy. Uruchamiaj per klatka: python genframes_v3.py <scena>_<first|last>.
"""
import os, sys, json
...
BP = {s["id"]: s for s in json.load(open(os.path.join(BASE, "blueprint-v3.json"), encoding="utf-8"))["sceny"]}
