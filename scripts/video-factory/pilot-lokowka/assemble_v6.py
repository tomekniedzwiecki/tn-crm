...
PLAN = [
    ("h1",     "r5_h1.mp4",      0.0, 2.3, "vo3_h1.mp3",   "eq=brightness=0.02:saturation=1.03,unsharp=5:5:0.5"),
    ("h2",     "r5_h2.mp4",      0.0, 1.0, "vo3_h2.mp3",   None),
    ...
    ("react",  "v2_react.mp4",   0.0, 3.4, "vo3_react.mp3","hflip,eq=brightness=0.024:saturation=1.04,unsharp=5:5:0.6"),
    ("prog",   "v6_prog.mp4",    0.2, 4.2, "vo3_prog.mp3", None),
    ("mech2",  "r5_mech2.mp4",   0.0, 2.0, "vo3_mech2.mp3","eq=brightness=0.02:saturation=1.03,unsharp=5:5:0.5"),
    ("shake",  "v6_shake.mp4",   0.2, 3.1, "vo3_shake.mp3",None),
...
def main():
    ...
    final = os.path.join(OUT, "ad_v6.mp4")
    cmd = ["ffmpeg", "-v", "error"]
