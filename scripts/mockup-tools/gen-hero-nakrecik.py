# -*- coding: utf-8 -*-
"""Hero-loopy NAKRECIK (Kling PRO i2v) — F5 lp_zycie. Cinemagraph anty-morfing: osoba, dlonie,
uchwyt na szyi i telefon PERFEKCYJNIE ZAMROZONE (jak zdjecie); animacja = delikatny dryf cieplego
swiatla z okna + subtelna atmosfera. Kamera locked. 2 klipy: desktop (sc-hero-d) + mobile (sc-hero-m).
Wynik: video/hero-loop{,-m}.{mp4,webm} + -poster.webp + assets/hero-video.mp4. Adaptacja gen-hero-migotek.py."""
...
NEG = ("camera movement, camera pan, camera zoom, person moving, body moving, head turning, face changing, "
       "hands moving, fingers moving, arms moving, knife moving, phone moving or sliding, neck mount moving "
       "or deforming or morphing, device changing shape, new objects appearing, extra fingers, text, captions, "
       "watermark, logo, brand name, glitch, fast motion, warping")
ASSETS = BASE + "/storage/v1/object/public/attachments/bud-assets/nakrecik/assets/"
PROMPT = ("Cinemagraph-style extremely subtle looping motion: warm daylight from the window shimmers and "
          "breathes softly across the scene, a faint gentle drift of warm air, the smartphone screen glows "
          "faintly. The person, their face, both hands, the graphite silicone neck mount and the attached "
          "phone all stay PERFECTLY still and frozen like a photograph — no body, hand, finger or device "
          "motion, the neck mount keeps its exact shape. Locked-off camera, photorealistic, calm seamless "
          "loop, warm bright kitchen.")
CLIPS = [
...
print("KONIEC gen-hero-nakrecik")
