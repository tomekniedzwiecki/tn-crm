Jesteś KRYTYKIEM przewodnika graficznego (gate F1.7, runda 2 po korekcie). Poprzednia runda
dała FAIL z 4 blokującymi: (1) zakaz tekstu niedomknięty, (2) sprzeczna ekspozycja obu boków
produktu w ORIENT, (3) sc-selfie nieczytelny produkt w szerokim planie, (4) pętla ANIM
first=last niemożliwa przy przesunięciu netto. Sprawdź WYŁĄCZNIE czy korekta v2 (sekcja na
końcu + zmiany w seedach) domyka te 4 punkty + czy zalecenia (decyzje fotel/okno, fallback
dłoni) są ustalone. FORMAT: `WERDYKT: PASS` albo `WERDYKT: FAIL` + max 4 punkty. Zwięźle.
