-- Szablon: pipeline_business_takeover
-- Gmail-style mail z propozycją przejęcia gotowego biznesu.
-- Zapis idzie do settings (nie email_templates) — patrz 20260416_pipeline_offer_cancelled_template.sql.

INSERT INTO settings (key, value) VALUES
('email_template_pipeline_business_takeover_subject', 'gotowy biznes do przejęcia'),
('email_template_pipeline_business_takeover_body',
'<!DOCTYPE html>
<html>
<head>
  <meta charset="UTF-8">
...
<body style="margin:0;padding:20px;background:#ffffff;font-family:Arial,Helvetica,sans-serif;color:#222;font-size:14px;line-height:1.5;">
  <div style="max-width:600px;">
    ...
    <p style="margin:0 0 14px 0;">osoba, której budowałem biznes musiała ze względów zdrowotnych zrezygnować. :( Jesteśmy już na etapie kampanii reklamowych i właśnie miały zacząć się pojawiać pierwsze zamówienia.</p>
    <p style="margin:0 0 14px 0;">Odzywam się do Ciebie i paru innych osób z tematem <strong>przejęcia tego już gotowego biznesu</strong>. Daj znać, czy chcesz wejść.</p>
    <p style="margin:0 0 20px 0;">Proszę o szybką decyzję, bo temat nie może czekać.</p>
