-- =============================================
-- ADD CUSTOMER_PHONE TO WORKFLOW_PROGRESS VIEW
-- =============================================
-- Enables searching workflows by phone number
...
SELECT
    ...
    w.customer_name,
    w.customer_company,
    w.customer_phone,  -- Added for phone search
    w.offer_name,
    w.amount,
    w.status,
    w.started_at,
...
COMMENT ON VIEW workflow_progress IS 'Aggregated workflow progress with video status and phone for admin dashboard';
