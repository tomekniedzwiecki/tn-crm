-- =============================================
-- ADD LAST ADMIN ACTIVITY TO WORKFLOW_PROGRESS VIEW
-- =============================================
-- Fixes: updated_at was showing any update (including client actions)
-- Now we show last admin activity from workflow_activities table
...
COMMENT ON VIEW workflow_progress IS 'Aggregated workflow progress with last admin activity for admin dashboard';
