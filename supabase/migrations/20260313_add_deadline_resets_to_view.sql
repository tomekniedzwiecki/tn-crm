-- =============================================
-- ADD DEADLINE_RESETS TO WORKFLOW_PROGRESS VIEW
-- =============================================
-- Fixes: deadline_resets column missing from view,
-- causing reset deadline feature to not work
...
SELECT
    ...
    w.starred,
    w.updated_at,
    w.deadline_resets,  -- ADDED: for step-based deadline resets
...
COMMENT ON VIEW workflow_progress IS 'Aggregated workflow progress with deadline_resets for admin dashboard';
