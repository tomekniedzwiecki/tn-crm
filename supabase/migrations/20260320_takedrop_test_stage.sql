...
ADD COLUMN IF NOT EXISTS test_notified_at TIMESTAMPTZ,
...
-- Comments
COMMENT ON COLUMN workflow_takedrop.test_notified_at IS 'When admin notified client that shop is ready for testing';
