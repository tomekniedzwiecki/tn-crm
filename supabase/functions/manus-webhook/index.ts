...
serve(async (req) => {
  ...
  try {
    ...
    if (findError || !adsRecord) {
      ...
      // NB: tor wf2 (fabryka banerów) NIE przechodzi już przez Manusa — grafiki robi ad-forge/fal
      // (decyzja Tomka 19.07). Routing ads_manus_task_id→wf2_products→wf2-ads usunięty wraz z funkcją.
