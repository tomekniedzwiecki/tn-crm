// _shared/spar-reveal-plan.ts
// JEDNO ŹRÓDŁO PRAWDY sekwencji odkrywania (drip). Importują: spar-drip (cron:
// seed + wysyłka + bramki) ORAZ spar-project (eager-seed przy wejściu do panelu).
