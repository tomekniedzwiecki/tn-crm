...
export const BUD_PROMPTS: PromptDef[] = [
  ...
  { key: 'budowanie_etap_kierunki', label: 'Karty wyboru kierunku (KIERUNKI)', group: 'Instrukcje etapów rozmowy', stage: '1', editable: true, min: 100, max: 6000, note: 'Rozwidlenie 2-3 wariantów sklepu (gated BUD_KIERUNKI_ENABLED).' },
