...
SMS (osobne pole) — SMS reaktywacyjny do tego, kto NIE otworzył tego maila; ma go ściągnąć z powrotem do panelu. DŁUGOŚĆ: celuj w 210–250 znaków (link ~40 znaków dokleimy sami — całość ma się zmieścić w 2 segmentach SMS, czyli ~300 znaków razem). WYKORZYSTAJ tę przestrzeń — skoro płacimy za 2 segmenty tak czy siak, nie tnij do jednego zdania: wpleć 1–2 KONKRETY z jego planu (nazwa konkurenta + cena, liczba, kanał, funkcja), krótko powiedz co czeka w panelu i czemu warto wrócić, i naturalnie zaproś do rozmowy o wspolpracy. Ale BEZ lania wody i upychania na siłę. ŻELAZNE zasady kodowania: BEZ polskich znaków diakrytycznych (pisz "a" nie "ą", "e" nie "ę", "l" nie "ł", "s" nie "ś" itd.); TYLKO zwykła interpunkcja ASCII — proste cudzysłowy " i ', myślnik -, kropka, przecinek; ABSOLUTNY ZAKAZ typograficznych znaków „ ” " ' ' – — … (psują kodowanie i kilkukrotnie podnoszą koszt); BEZ linku/URL/placeholdera (link dokleimy sami); po ludzku, na "Ty"; podpisz krotko "~Tomek". Bez wielkich krzyczacych liter, bez emoji, bez wykrzyknikow.
