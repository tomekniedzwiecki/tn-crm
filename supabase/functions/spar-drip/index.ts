...
SMS (osobne pole) — krótki SMS reaktywacyjny do tego, kto NIE otworzył tego maila; ma go ściągnąć z powrotem do panelu. ŻELAZNE zasady: maksymalnie 140 znaków (link dokleimy sami, zostaw na niego miejsce); BEZ polskich znaków diakrytycznych (pisz "a" nie "ą", "e" nie "ę", "l" nie "ł", "s" nie "ś" itd. — diakrytyki podnoszą koszt SMS); TYLKO zwykła interpunkcja ASCII — proste cudzysłowy " i ', myślnik -, kropka, przecinek; ABSOLUTNY ZAKAZ typograficznych znaków „ ” " ' ' – — … (psują kodowanie i kilkukrotnie podnoszą koszt); BEZ linku/URL/placeholdera; nawiąż jednym konkretem do JEGO pomysłu/tego artefaktu; po ludzku, na "Ty"; zasugeruj, że w panelu to czeka i że może pogadac o wspolpracy; podpisz krotko "~Tomek". Bez wielkich krzyczacych liter, bez emoji, bez wykrzyknikow.
