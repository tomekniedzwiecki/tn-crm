...
// Supported events
type TikTokEventType = 'SubmitForm' | 'CompleteRegistration' | 'CompletePayment' | 'ViewContent' | 'AddToCart' | 'InitiateCheckout' | 'Contact'
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // Validate event type
    const validEvents: TikTokEventType[] = ['SubmitForm', 'CompleteRegistration', 'CompletePayment', 'ViewContent', 'AddToCart', 'InitiateCheckout', 'Contact']
