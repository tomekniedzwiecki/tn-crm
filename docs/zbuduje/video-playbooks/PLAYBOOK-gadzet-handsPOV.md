...
> **Reguła rozstrzygająca — WIERNOŚĆ WZORCOWI (rewizja 20.07, wycofuje wersję sprzed):** archetyp i obecność TWARZY wynikają z NOŚNIKA VIRALNOŚCI wzorca (`blueprint.wzorzec.viral_carrier`), nie z kategorii produktu ani z chęci oszczędzenia. `gadzet-handsPOV` (bez twarzy) bierz TYLKO gdy wzorzec sam był hands-POV. Jeśli wzorzec wiralił na TWARZY / emocji / reakcji / testimonialu — także gdy produkt NIE działa na ciele, a twarz tylko przeżywa/komentuje → idź do `PLAYBOOK-beauty-talkinghead.md` i **reprodukuj twarz**. Kondensacja 15 s NIE jest powodem, by twarz wyciąć: skróć testimonial do 1-2 mówionych beatów z twarzą, resztę oddaj hands-POV = **HYBRYDA**. Koszt i ryzyko dryfu twarzy = świadomie akceptowane (wierność > oszczędność; PROCEDURA → ZASADA NADRZĘDNA). *Poprzednia reguła „gadżet+głowa → hands-POV, bo kondensacja tnie gadanie" była oszczędnością i została WYCOFANA (Tomek 20.07: „twarze zdecydowanie wtedy, kiedy są potrzebne — to one oddają emocje").*
