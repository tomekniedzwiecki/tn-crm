...
Praktycznie wyczerpany w falach F1+F2 (2026-07-17). ZROBIONE: central activation-across-apps · value-before-signup · agent-domyka-setup · axe-core a11y gate · Deliverability SLO · tier SMS · plan-core regeneracja serwerowa · meta-onboarding operatora · awaiting · server-aha · detektor aha · expected_ttfv · resurrection · friction · variant/progressive-profiling. POZOSTAJE:
