...
| L-025 | 2026-07-20 | decyzja Tomka (panel) | NARZĘDZIE | „Zrobione = NATYCHMIAST odnotowane w panelu" — sync /tn-app pomijany, bo ręczny REST + gotcha VERBATIM WS = tarcie; fabryka sklepów ma panel-sync.py, TN App nie miała odpowiednika → `wfa-panel-sync.mjs` (step_update/checklist z WS/notatka/kronika) + rytuał §3.4.6 (in_progress na starcie, done zaraz po domknięciu) | W TOKU | METODYKA §3.4.6 + §2b pkt 4; narzędzie: sesja 2026-07-20 |
