...
| L-009 | 2026-07-16 | Dobry Wstęp S3 | NARZĘDZIE | auth-E2E jako skrypt fabryki (auth-e2e.mjs) zamiast ręcznych FAZ 0-5 przy kroku auth_konta | ZGŁOSZONA | dobrywstep BUILDLOG S3; kandydat na sesję narzędziową |
