...
## W skrócie (dla wygody — wiążąca jest treść dalszych sekcji)

- Administratorem Twoich danych jest **Tomasz Niedźwiecki (Tomasz Niedźwiecki AI)**. Kontakt w sprawach danych: **ceo@tomekniedzwiecki.pl**.
- Rozmawiasz z **systemem AI** wyraźnie oznaczonym w interfejsie — nie z człowiekiem.
- **Nie wpisuj do rozmowy danych wrażliwych** (o zdrowiu, poglądach, itp.) ani cudzych danych, których nie masz prawa udostępniać. Treść rozmowy jest zapisywana.
- Twoje dane trafiają do zaufanych dostawców: hosting i baza, dostawca modelu AI (poza EOG — z zabezpieczeniami), operator płatności, poczta e-mail, hosting strony.
- **Operator płatności jest odrębnym administratorem** własnych danych płatniczych.
- Masz prawo dostępu, sprostowania, usunięcia, ograniczenia, przenoszenia i sprzeciwu, a także prawo skargi do **PUODO**.
- **Nie podejmujemy zautomatyzowanych decyzji** wywołujących wobec Ciebie skutki prawne.

---

## 1. Administrator danych

1. Administratorem Twoich danych osobowych jest **Tomasz Niedźwiecki**, prowadzący jednoosobową działalność gospodarczą pod firmą **„Tomasz Niedźwiecki AI"**, ul. Grawerska 30L, 51-180 Wrocław, NIP 6972240255, REGON 302211341 (dalej: **Administrator**).
2. We wszystkich sprawach dotyczących przetwarzania danych oraz realizacji Twoich praw skontaktuj się pod adresem e-mail **ceo@tomekniedzwiecki.pl**. Administrator nie wyznaczył Inspektora Ochrony Danych.

---

## 2. Skąd mamy dane i czego dotyczą

Przetwarzamy dane, które podajesz sam(a) lub które powstają w trakcie korzystania z serwisu /aplikacja:

- przy **zakładaniu konta** (e-mail i hasło albo logowanie kontem Google/Facebook — wtedy dostawca tożsamości przekazuje nam Twój e-mail i podstawowe dane konta),
- w **Rozmowie Projektowej z Asystentem AI** (treść tego, co wpisujesz, oraz wygenerowane Materiały Koncepcyjne),
...
| **Rozmowa z Asystentem AI** i generowanie Materiałów Koncepcyjnych (rozmowa darmowa i kolejna 49 zł) | art. 6 ust. 1 lit. b — wykonanie umowy o dostarczenie usługi/treści cyfrowej | Treść rozmowy jest zapisywana na Twoim koncie |
...
Podanie danych jest dobrowolne, ale niezbędne do skorzystania z odpowiedniej usługi (np. bez e-maila nie założysz konta, bez danych do faktury nie wystawimy dokumentu).

---

## 4. Odbiorcy danych (podmioty przetwarzające i odrębni administratorzy)

Korzystamy z zaufanych dostawców. Działają oni jako **podmioty przetwarzające** (w naszym imieniu, na podstawie umów powierzenia — art. 28 RODO), chyba że zaznaczono inaczej:
...
**Transfery poza EOG.** Część dostawców (dostawca modelu AI, Vercel, Resend) przetwarza dane w USA. Odbywa się to na podstawie mechanizmów zgodnych z rozdziałem V RODO — **standardowych klauzul umownych (SCC)** oraz, jeśli dotyczy, uczestnictwa dostawcy w **Data Privacy Framework** — wraz z niezbędnymi środkami dodatkowymi. Kopię lub informację o zastosowanych zabezpieczeniach udostępniamy na żądanie (ceo@tomekniedzwiecki.pl).

**Operator płatności jako odrębny administrator.** Dane niezbędne do rozliczenia płatności przetwarza operator płatności jako **samodzielny administrator**, na zasadach własnej polityki prywatności. My otrzymujemy jedynie potwierdzenie i podstawowe dane transakcji — **nie mamy dostępu do pełnych danych Twojej karty**.

---

## 5. Kategorie danych — i ważne ostrzeżenie o treści rozmów

Przetwarzamy w szczególności:

- **dane identyfikacyjne i kontaktowe:** imię, nazwisko, nazwa firmy i NIP (jeśli podasz), e-mail, telefon, adres,
...
- **treść Rozmów z Asystentem AI i Materiały Koncepcyjne** zapisane na Twoim koncie,
- **dane techniczne** (adres IP, przeglądarka, urządzenie, cookies).

> ⚠️ **Ostrzeżenie — treść rozmów.** Rozmowa z Asystentem AI dotyczy Twojego pomysłu na narzędzie cyfrowe. **Podawaj tylko dane niezbędne do rozmowy.** Nie wpisuj:
...
> - danych osób trzecich (np. Twoich klientów, pracowników), do których udostępnienia nie masz podstawy,
> - haseł, pełnych numerów kart, tajemnic, których nie chcesz utrwalać.
>
> Administrator **nie zabiega** o dane wrażliwe i nie przewiduje ich przetwarzania. Jeżeli mimo to je podasz, wpisujesz je z własnej inicjatywy i na własną odpowiedzialność.

**Nie wykorzystujemy treści Twoich Rozmów do trenowania własnych modeli AI.**
...
| Treść Rozmów z AI | do czasu realizacji celu (obsługa projektu / prowadzenie konta), nie dłużej niż **[DO POTWIERDZENIA — X miesięcy]** od ostatniej aktywności, o ile nie zostaną wcześniej usunięte na Twoje żądanie |
...
Masz prawo do: **dostępu** do danych, **sprostowania**, **usunięcia** („bycia zapomnianym"), **ograniczenia przetwarzania**, **przenoszenia danych**, **sprzeciwu** wobec przetwarzania opartego na uzasadnionym interesie (w tym marketingu bezpośredniego), a także **wycofania zgody** w każdej chwili (bez wpływu na zgodność z prawem przetwarzania sprzed wycofania).

Aby skorzystać z praw — napisz na **ceo@tomekniedzwiecki.pl**.
...
Twoje dane **nie służą do zautomatyzowanego podejmowania decyzji** (w tym profilowania) wywołujących wobec Ciebie **skutki prawne** lub w podobny sposób istotnie na Ciebie wpływających. Asystent AI generuje materiały poglądowe i propozycje — **nie podejmuje wiążących decyzji** w Twojej sprawie.

---

## 9. Informacja o sztucznej inteligencji (art. 50 AI Act)

Rozmowy w serwisie prowadzi **system sztucznej inteligencji (Asystent AI)** działający w imieniu Administratora, **wyraźnie oznaczony w interfejsie** — tak, abyś wiedział(a), że rozmawiasz z systemem AI, a nie z człowiekiem. Obowiązek ten wynika z **art. 50 rozporządzenia (UE) 2024/1689 (AI Act)**, stosowanego od 2 sierpnia 2026 r. Materiały generowane z udziałem AI mają charakter poglądowy i mogą zawierać błędy — decyzje podejmujesz samodzielnie.

---

## 10. Pliki cookies

Serwis wykorzystuje pliki cookies (niezbędne, funkcjonalne, analityczne, a jeśli dotyczy — marketingowe). Ustawienia cookies możesz zmienić w przeglądarce. Szczegóły — jak w ogólnej polityce cookies serwisu.

---

## 11. Zmiany polityki

Politykę możemy aktualizować (np. przy zmianie przepisów lub dostawców). Aktualna wersja jest publikowana na stronie i obowiązuje od wskazanej daty.
