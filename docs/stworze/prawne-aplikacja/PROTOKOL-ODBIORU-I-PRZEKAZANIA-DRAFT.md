# PROTOKOŁY — ODBIÓR MVP oraz PRZEKAZANIE PROWADZENIA OPERACYJNEGO — WZORY
...
## B. PROTOKÓŁ PRZEKAZANIA PROWADZENIA OPERACYJNEGO
...
- ☐ Upływ **12 miesięcy od Startu produkcyjnego** (§ 1 ust. 4 Umowy) — prowadzenie operacyjne przechodzi na Operatora niezależnie od liczby klientów.
...
Po przekazaniu prowadzenia operacyjnego Wykonawca nadal świadczy — na zasadach Umowy:
...
**Udział** Wykonawcy (rev-share) obowiązuje nadal na zasadach Umowy — przekazanie prowadzenia operacyjnego **nie** jest wykupem Udziału (wykup reguluje § 9 Umowy oraz odrębna umowa wykupu).

### 4. Potwierdzenie
Strony potwierdzają dokonanie przekazania prowadzenia operacyjnego w zakresie z pkt 2 oraz kontynuację świadczeń z pkt 3.
