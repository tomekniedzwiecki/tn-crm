...
**Wykonawca:** Tomasz Niedźwiecki, „Tomasz Niedźwiecki AI", ul. Grawerska 30L, 51-180 Wrocław, NIP 6972240255.
...
> Różnica między B (PNPK) a C dotyczy **charakteru zawodowego** umowy: decyduje, czy budowa aplikacji wpisuje się w przedmiot działalności Składającego oświadczenie. W razie wątpliwości należy opisać swoją sytuację — status zostanie ustalony wspólnie, zgodnie ze stanem faktycznym.
