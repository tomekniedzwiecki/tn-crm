...
1. Po upływie 12 miesięcy od Startu produkcyjnego Partner może w każdej chwili wykupić Udział za cenę równą **36-krotności średniej miesięcznej kwoty Udziału z ostatnich 12 miesięcy**.
...
- Cena wykupu po upływie 12 miesięcy, przy średniej miesięcznej kwocie Udziału **1 000 zł**, wynosi **36 000 zł** (36 × 1 000 zł — § 9 ust. 1).
- Przy wcześniejszym wykupie w związku ze zbyciem biznesu (§ 10 ust. 1), np. po 3 pełnych miesiącach ze średnią kwotą Udziału **300 zł**, cena wykupu wynosi **15 375 zł brutto** (36 × 300 zł = 10 800 zł, ale nie mniej niż cena minimalna 15 375 zł).
...
11. **§ 10 ust. 1** — wcześniejszy wykup (przed 12 mies.): 36× śr. z pełnych miesięcy, **min. 15 375 zł brutto** (= cena budowy brutto); zero pełnych miesięcy = tylko cena minimalna. Kwota do potwierdzenia — Tomek.
...
2. **Śmierć / trwała niezdolność Tomka (§ 15 ust. 4).** Po finalnej opinii gpt-5.6-sol (22.07) ODWRÓCONO na wariant z DZIEDZICZENIEM: Udział jako odroczona część ceny za przeniesienie praw NIE wygasa ze śmiercią — przysługuje następcom prawnym Tomka do wykupu (§ 9) albo upływu terminu z § 6 ust. 1; jeżeli w 30 dni nikt zdolny nie przejmie opieki, opieka i serwis wygasają, a następcy przekazują Partnerowi repozytorium, administrację infrastrukturą i dostępy (bez gaszenia Udziału). Obie opinie prawne wskazały, że wariant „Udział wygasa ze śmiercią" podważa konstrukcję Udziału jako ceny za prawa i pozbawia rodzinę przychodu. Marker decyzyjny pozostaje w treści § 15 ust. 4 — Tomek może świadomie wybrać wariant wygaśnięcia jako gest wobec klientów.
...
5. **Placeholdery do wypełnienia przy generowaniu:** `{{FEE_PERCENT}}` (default 10), `{{TERMIN_TYGODNI}}` (zwykle 4–8 tyg.), `{{NAZWA_APLIKACJI_ROBOCZA}}`, dane stron. **UWAGA (zmiana v4.1): dodano NOWY placeholder `{{BUDZET_ROZRUCHU}}` (§ 1 ust. 4)** — nie ma go jeszcze w `contract_fields` ani w mapie renderującej (`tn-app/projekt.html`, `wfa-portal`). Przed powrotem dokumentu do HTML: albo dodać pole do systemu, albo wpisać wartość na sztywno w treści — inaczej niepodstawiony placeholder wyciekłby na wydruk (analogicznie do pułapki PESEL, pkt 3).
6. **Termin maksymalny Udziału — 15 lat (§ 6 ust. 1).** Wprowadzono górny limit: Udział należny za okresy do upływu 15 lat od Startu produkcyjnego (uruchomienia sprzedaży), chyba że wcześniej wykup. Rekomendacja prawnika: termin maksymalny znacząco wzmacnia obronę przed art. 365¹ k.c., a 15 lat jest ekonomicznie ~równoważne bezterminowości. **Potwierdź liczbę lat.**
...
9. **Budżet reklamowy rozruchu (§ 1 ust. 4) — `{{BUDZET_ROZRUCHU}}` [DO USTALENIA].** FAQ nie rozstrzyga, kto finansuje budżet reklam w fazie rozruchu (Tomek czy Partner). **Ustal i wpisz.**
