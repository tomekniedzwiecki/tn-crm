...
Nazwa: Ulepszek
Tagline: Codzienność w lepszej wersji
Opis marki (do answer-first, przeredaguj zwięźle): Ulepszek to sklep z produktami, które podnoszą codzienność o poziom — od treningu w domu, przez kuchenne patenty, po chwile regeneracji. Każda rzecz przechodzi selekcję: zostają tylko te, które realnie ułatwiają życie i robią to lepiej niż stary sposób. Płacisz przy odbiorze, a jeśli coś nie zagra — masz 14 dni na zwrot.
Paleta (role): primary #2D5BFF · ink #23272E · bg #F6F7FB · surface #E9EEFF · accent-2 #FFC93C · neutral #7C8391 (JASNE tła)
...
Fonty: heading: Gabarito (latin-ext) · body: Onest (latin-ext) (Google Fonts, subset latin-ext, display=swap)
Logo (topbar, wys. ~36-40px): https://yxmavwkwnfuphjqbelws.supabase.co/storage/v1/object/public/attachments/bud-assets/parasol-ulepszek/brand/logo-combo.png
Favicon: https://yxmavwkwnfuphjqbelws.supabase.co/storage/v1/object/public/attachments/bud-assets/parasol-ulepszek/brand/favicon-512.png
...
- Brzuszek: Składana maszyna do ćwiczeń brzucha i core · 429,00 zł · foto https://yxmavwkwnfuphjqbelws.supabase.co/storage/v1/object/public/attachments/bud-assets/brzuszek/assets/sc-hero-800.webp
- taca do szybkiego rozmrażania mięsa: taca do szybkiego rozmrażania mięsa · 289,00 zł · foto https://yxmavwkwnfuphjqbelws.supabase.co/storage/v1/object/public/attachments/bud-assets/rozmrozik/assets/sc-hero-thawed-800.webp
- Rozgrzewek: Podgrzewany masażer do ciała · 84,90 zł · foto https://yxmavwkwnfuphjqbelws.supabase.co/storage/v1/object/public/attachments/bud-assets/rozgrzewek/assets/sc-hero-800.webp
...
CO JEST NIETYKALNE (struktura/mechanika layoutu — NIE RUSZAĆ):
  ...
  • KOMPLET linków prawnych: Regulamin · Polityka prywatności · Polityka cookies ·
    Zwroty i reklamacje · Dostawa · Kontakt — href = PLACEHOLDERY {{REGULAMIN_URL}} itp.
    (podmiana przy publikacji, jak {{CANONICAL_URL}}; komplet stron publikuje legal-forge.py
    w kroku pl_prawne — SSOT docs/zbuduje/PRAWNE.md),
