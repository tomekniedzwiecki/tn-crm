...
Nazwa: Sprytko
Tagline: Codzienność, tylko sprytniej
Opis marki (do answer-first, przeredaguj zwięźle): Sklep ze sprytnymi rzeczami, które ułatwiają codzienność — praktyczne gadżety i domowe patenty wybrane tak, żeby po prostu działały. Bez kombinowania, bez rozczarowań.
Paleta (role): primary #4CAF6E · ink #24303A · bg #FCF9F3 · surface #FFFFFF · deep #1F3D34 · border #EAE4D8 (JASNE tła)
...
Fonty: heading: Quicksand (latin-ext) · body: Inter (latin-ext) (Google Fonts, subset latin-ext, display=swap)
Logo (topbar, wys. ~36-40px): https://yxmavwkwnfuphjqbelws.supabase.co/storage/v1/object/public/attachments/bud-assets/parasol-sprytko/brand/logo-combo.png
Favicon: https://yxmavwkwnfuphjqbelws.supabase.co/storage/v1/object/public/attachments/bud-assets/parasol-sprytko/brand/favicon-256.png
...
--- PRODUKTY (przykładowe DANE do wyczucia proporcji; NIE wpisuj ich w HTML — karty wstrzyknie montaż przez markery; 1 szt. teraz, będzie rosło) ---
- Zaklipek: Przyklipsowy hub USB do biurka: zaciśnij na krawędzi blatu i miej 4 porty USB 3.0 zawsze pod ręką. · 34,90 zł · foto https://yxmavwkwnfuphjqbelws.supabase.co/storage/v1/object/public/attachments/bud-assets/zaklipek/scenes/oferta.webp
