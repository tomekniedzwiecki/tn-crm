...
Nazwa: Zaradek
Tagline: Sprytne patenty na codzienność
Opis marki (do answer-first, przeredaguj zwięźle): Zaradek to sklep ze sprytnymi patentami, które upraszczają codzienne sprawy — od kuchni, przez trening, po drobne wygody dnia. Wybieramy rzeczy, które naprawdę robią robotę: proste w użyciu, przemyślane i warte swojej ceny. Asortyment rotuje — zawsze krótka lista, zawsze konkret.
Paleta (role): primary #1F2A44 · accent #2F8F5B · accent-2 #F0B441 · bg #FAF6EF · surface #FFFFFF · border #E5DCCB (JASNE tła)
...
Fonty: heading: Quicksand (latin-ext) · body: Mulish (latin-ext) (Google Fonts, subset latin-ext, display=swap)
Logo (topbar, wys. ~36-40px): https://yxmavwkwnfuphjqbelws.supabase.co/storage/v1/object/public/attachments/bud-assets/parasol-zaradek/brand/logo-combo.png
Favicon: https://yxmavwkwnfuphjqbelws.supabase.co/storage/v1/object/public/attachments/bud-assets/parasol-zaradek/brand/favicon-32.png
...
- Odsączek: Składany koszyk do smażenia · 29,90 zł · foto https://yxmavwkwnfuphjqbelws.supabase.co/storage/v1/object/public/attachments/bud-assets/odsaczek/scenes/oferta.webp
- Skrolik: Pierścień do przewijania · 34,90 zł · foto https://yxmavwkwnfuphjqbelws.supabase.co/storage/v1/object/public/attachments/bud-assets/skrolik/scenes/oferta.webp
- Ugniatek: Masażer powięziowy · 189,00 zł · foto https://yxmavwkwnfuphjqbelws.supabase.co/storage/v1/object/public/attachments/bud-assets/ugniatek/scenes/oferta.webp
